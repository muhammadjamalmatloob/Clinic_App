                ...
                SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                    child: queueAsync.when(
                            ...
                            children: [
                              ...
                              GlassCard(
                                ...
                                child: ListTile(
                                  ...
                                  subtitle: const Text(
                                    'Push notification to all waiting patients',
                                  ),
                                  trailing: const Icon(
                                    Icons.send,
                                    color: AppColors.primaryPlum,
                              ...
                              currentServingAsync.when(
                                ...
                                error: (_, __) =>
                                    const Text('Error loading current token'),
                              ),
                              const SizedBox(height: 24),
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            return Card(
                                              child: ListTile(
                                                ...
                                                subtitle: Text(
                                                  'Est. Wait: ${token.estimatedWaitTimeMinutes} mins',
                                                ),
                                                trailing: const Icon(
                                                  Icons.more_vert,
                                                ),
                      ...
                      error: (e, stack) =>
                          Center(child: Text('Failed to load queue: $e')),
                    ),
                  ),
                ),
